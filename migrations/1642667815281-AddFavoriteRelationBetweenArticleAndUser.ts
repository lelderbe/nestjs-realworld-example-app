...
export class AddFavoriteRelationBetweenArticleAndUser1642667815281
	implements MigrationInterface {
	name = 'AddFavoriteRelationBetweenArticleAndUser1642667815281';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`ALTER TABLE "articles" DROP CONSTRAINT "FK_63dfa57d8189ef8d16ed9a83dea"`,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "articles" ADD CONSTRAINT "FK_63dfa57d8189ef8d16ed9a83dea" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}
}
